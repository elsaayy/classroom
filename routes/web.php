...
Route::middleware('auth')->group(function() {
    ...
    Route::get('/forgotpass', [SettingsController::class, 'forgotpass'])->name('settings.lupapass');
    Route::get('/change-new-pass', [SettingsController::class, 'changeNewPass'])->name('settings.newpass');

    Route::post('/check-mail', [MailController::class, 'verifyOtp'])->name('settings.checkmail');
    Route::post('/mail-pass', [MailController::class, 'sendOtp'])->name('settings.mailpass');
    ...
    Route::post('/archive/reverse/{id}', [ArchiveController::class, 'reverse'])->name('archive.reverse');
